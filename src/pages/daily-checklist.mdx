...
- [x] GitHub GraphQL endpoint populate pie chard with values
- [x] GitHub GraphQL endpoint populate pie chard with colours
- [ ] GitHub GraphQL endpoint parse request data
