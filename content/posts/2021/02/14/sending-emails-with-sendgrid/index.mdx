...
A custom email address to send from, I have done this in the past with
Zoho and you can check [Setting up a Custom Email with Zoho] for
details on that.

A from on your site to collect the information with, I use Kews Forms
which isn't completely redundant a this point as it has great
validation that can be used.
