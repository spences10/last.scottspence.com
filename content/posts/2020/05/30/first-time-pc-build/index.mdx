...
[the empty case]: ./case-with-power.webp
[cpu fan clearance]: ./cpu-fan-clearance.webp
[fan covering memory slots]: ./fan-covering-memory.webp
[case screws]: ./case-screws.webp
[cables]: ./cables.webp
[gpu assembly]: ./gpu-assembly.webp
[case front with gpu installed]: ./gpu-installed.webp
[case back gpu installed]: ./gpu-fan-side.webp
[motherboard front panel headers]: ./case-headers.webp
[motherboard wired]: ./motherboard-wired.webp
[ready to close]: ./ready-to-close.webp
[closed case]: ./closed-case.webp
