...
defaults into my `theme` object.

I'm going to do that now, create a `theme-defaults.js` file in the
`theme` directory, then create a `theme.js` file where I'll add in the
theme properties I want in there.
