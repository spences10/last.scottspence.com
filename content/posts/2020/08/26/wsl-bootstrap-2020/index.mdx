...
Now is a good time to install [linux from the ms store] I'll be using
Ubuntu.
...
Time to add all the web dev tools you need, for me this is
...
[linux from the ms store]: https://aka.ms/wslstore
