...
This time 'round it was just as confusing (for me) at the times
before, so this is why I'm making notes for future Scott to refer to.
🔥
...
If you don't have Windows Pro you should still be able to enable WSL 2
on [Windows 10 home].
...
Prior to this, I [had to install Git on Windows] which had it's own
set of problems with line endings and file permissions.
