...
hostory going back to [the start of 2017].
...
The odd bit was that you could only add in a bullit fashion, so if you
...
start refering to their users/employees as tribes, "Roamers",
"Googlers", no thanks.
...
repository which is on a provate GitHub repo.
