...
This post is mainly in response to some seeing an increasing amount
unreasonable requests for the take home project.
...
than 3 hours, you have a shortlist of 6 candidates (18 hours of throw
away work)
