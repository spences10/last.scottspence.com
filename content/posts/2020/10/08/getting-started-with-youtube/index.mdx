...
with the quality of my Fifine USB mic I got back in 2018.
...
You can right click on the Scene name and select Rename to give it a
more meaningful name if you wish.
...
stay on the camera, like when that delivery you've been waiting all
day to turn up knocks on your door ten minutes into a stream!
...
Here you can add in the duration and the start and stop text.
