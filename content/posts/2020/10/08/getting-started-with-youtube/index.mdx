...
from a lot of YouTubers when someone asks "How to be a YouTuber?"
they'll say, start, iterate, get better. You'll never start off with a
prefect first video.
...
a bit too rough around the edges to justify it.
