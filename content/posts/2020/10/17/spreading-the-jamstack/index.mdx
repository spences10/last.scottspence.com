...
The core philopiphy is to generate as much as you can at build time
then server that statically from a CDN.
...
An index.html file is a Jamstack site
...
- I'm not sure about how much details I can give about recent projects
  so I'll say...
