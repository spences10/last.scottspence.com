<Small>
  Last updated: <DateUpdated date={`2021-02-04`} small={`true`} />
</Small>
...
CMS' that are emerging [Sanity.io], [GraphCMS], [Strapi], [Keystone 5]
or [Contentful].

I have experience commercial experience with Contentful and have built
projects in Sanity.io and GraphCMS. I'm currently working on a project
now that uses Keystone 5.
